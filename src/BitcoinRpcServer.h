...
#ifndef DIGIASSET_CORE_BITCOINRPCSERVER_H
#define DIGIASSET_CORE_BITCOINRPCSERVER_H
...
struct Method {
    std::string name;
    std::function<Value(const Value& params)> func;
};
...
#endif //DIGIASSET_CORE_BITCOINRPCSERVER_H
